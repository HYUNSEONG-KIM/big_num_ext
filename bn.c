...
void bignum_from_string(struct bn* n, char* str, int nbytes) // Memo: Only treat the hexadecimal string
{
  require(n, "n is null");
...
void bignum_to_string(struct bn* n, char* str, int nbytes) // hexadecimal string
{
  require(n, "n is null");
  require(str, "str is null");
  require(nbytes > 0, "nbytes must be positive");
